...
const DeleteAllExecutionsButton = () => {
    ...
    const {selectedRoutineId, setSelectedExecutions} = useContext(executionContext);
    const { deleteAllExecutions } = useExecutions(selectedRoutineId, undefined, { fetchOnMount: false });
